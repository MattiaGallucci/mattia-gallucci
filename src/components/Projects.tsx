...
const projects = [
  ...
  },
  {
    ...
    fullDescription: "GoalGuru è un sistema di predizione sportiva che utilizza algoritmi di machine learning avanzati per analizzare dati calcistici e prevedere i risultati delle partite. Il progetto integra diverse fonti di dati, inclusi statistiche delle squadre, performance dei giocatori e condizioni meteorologiche. Attraverso l'uso di reti neurali profonde, il sistema è in grado di fornire predizioni semi-accurate.",
  ...
  },
  {
    ...
    fullDescription: "SwaGGed è una piattaforma social innovativa progettata specificamente per la comunità musicale. Il progetto presenta un'architettura complessa che include sistemi di votazioni, gestione di contenuti, sistemi di rating e recensioni, e funzionalità social avanzate. L'applicazione è stata sviluppata seguendo principi di ingegneria del software moderni, con particolare attenzione alla scalabilità, sicurezza e user experience. Include funzionalità come condivisione di idee, creazione di community, sistema di like e condivisione di commenti.",
  ...
  },
  {
    ...
    fullDescription: "Questo progetto di ricerca interdisciplinare esplora la complessa relazione tra indicatori socioeconomici e fenomeni criminali attraverso l'applicazione rigorosa di metodologie statistiche avanzate. L'analisi include la raccolta e pulizia di dataset governativi, l'applicazione di test di correlazione, regressione lineare, analisi delle serie temporali e modellazione predittiva. Il progetto ha prodotto insights significativi sulle dinamiche sociali, contribuendo alla comprensione di come fattori economici possano influenzare la sicurezza pubblica, con implicazioni per le politiche sociali.",
  ...
  },
  {
    ...
    fullDescription: "Questo progetto comprende la progettazione e implementazione completa di un sistema informativo per la gestione delle operazioni aeroportuali. Il sistema gestisce prenotazioni voli, check-in passeggeri,scheduling equipaggi e manutenzione aeromobili. La progettazione include un'analisi approfondita dei requisiti, modellazione ER, normalizzazione del database, e sviluppo di un'interfaccia utente per diverse tipologie di operatori. Il progetto dimostra competenze in progettazione di database, ottimizzazione query e gestione di sistemi complessi.",
